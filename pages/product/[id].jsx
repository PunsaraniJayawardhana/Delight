...
const Product = ({ product }) => {
  ...
  const handleClick = () => {
    const numericQuantity = parseInt(quantity, 10) || 1; // Default to 1 if quantity is not a valid number
    dispatch(addProduct({ ...product, extras, price, quantity: numericQuantity }));
  };
